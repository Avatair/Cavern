...
public class CaveAchievements
{
	...
	public static final Achievement HUGE_CAVERN = CaveAchievement.of("hugeCavern", -8, 0, CaveBlocks.HUGE_CAVERN_PORTAL, null);
	...
	public static final Achievement MAGIC_COMPOSITING = CaveAchievement.of("magicCompositing", 7, 11, ItemMagicalBook.EnumType.COMPOSITING.getItemStack(), SUMMONER);
	public static final Achievement MAGIC_FLAME_BREATH = CaveAchievement.of("magicFlameBreath", 9, 11, ItemMagicalBook.EnumType.FLAME_BREATH.getItemStack(), MAGICIAN);
	public static final Achievement MAGIC_EXPLOSION = CaveAchievement.of("magicExplosion", 5, 13, ItemMagicalBook.EnumType.EXPLOSION.getItemStack(), MAGIC_FLAME_BREATH);
	public static final Achievement MAGIC_WARP = CaveAchievement.of("magicWarp", 7, 13, ItemMagicalBook.EnumType.WARP.getItemStack(), MAGICIAN);
